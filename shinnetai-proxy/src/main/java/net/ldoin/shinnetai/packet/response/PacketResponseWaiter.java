...
public class PacketResponseWaiter {
    ...
    public void shutdown() {
        syncWaiters.forEach((id, waiter) -> waiter.latch.countDown());
        syncWaiters.clear();
        asyncWaiters.forEach((id, future) -> future.completeExceptionally(new CancellationException("Response waiter was shut down")));
        asyncWaiters.clear();
    }
