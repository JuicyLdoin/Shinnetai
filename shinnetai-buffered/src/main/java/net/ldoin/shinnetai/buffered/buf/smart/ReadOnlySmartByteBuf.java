...
public final class ReadOnlySmartByteBuf extends SmartByteBuf {
    ...
    public static ReadOnlySmartByteBuf of(byte[] bytes, int offset, int length) {
        return new ReadOnlySmartByteBuf(bytes, offset, length);
    }
    ...
    private ReadOnlySmartByteBuf(byte[] bytes, int offset, int length) {
    ...
    public ReadOnlySmartByteBuf writeBytesRaw(byte[] values) {
        throw new UnsupportedOperationException("Only read ByteBuf");
    }
